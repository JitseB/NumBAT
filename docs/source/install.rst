...
# If you encounter an error like "fatal errror: umfpack.h No such file or directory", please run ``export CPPFLAGS="-I/usr/include/suitesparse"`` before running make. This makes sure that the SuiteSparse library that was previously installed can be included.
--------------------------
